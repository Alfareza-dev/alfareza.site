      ...
      {!posts.length ? (
        ...
        <div className="grid gap-6">
          {posts.map((post) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              
              <div className="relative z-10">
                <h2 className="text-2xl font-semibold mb-2 group-hover:text-brand-primary transition-colors">
                  {post.title}
                </h2>
                ...
                <div className="mt-6 flex items-center text-sm font-medium text-brand-primary group-hover:text-brand-primary/80 transition-colors">
