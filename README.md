<div align="center">
  ...
  <img src="https://img.shields.io/badge/Gemini%20AI-4285F4?style=for-the-badge&logo=google-gemini&logoColor=white" alt="Google Gemini" />
  <img src="https://img.shields.io/badge/TypeScript-007ACC?style=for-the-badge&logo=typescript&logoColor=white" alt="TypeScript" />
  <br />

  # 🛡️ Alfareza.site | C2 Security Architecture
  **An elite Next.js 14 web application fortified with a real-time, interactive Telegram Security Operations Center.**
...
This system intercepts malicious web traffic, analyzes attack vectors using **Google Gemini AI**, and dispatches actionable alerts to a private Telegram channel. From there, administrators can execute 2-step verified mitigations entirely from their mobile devices.

---

## 💎 Core Capabilities

### 🪤 Adaptive Honeypots & AI Analysis
...
- **Gemini Threat Triage:** Raw attack payloads are piped through `@google/generative-ai` to synthesize the attack intent, origin, and toolset in concise, tactical language.
...
- 📊 **Live Telemetry:** Queries `visitor_stats` and `blocked_ips` to display active traffic footprints and system ban counts.
- ⚙️ **Maintenance Toggles:** A stateful button that reflects [(ON)](cci:1://file:///Users/alfareza/Documents/Data/Code/Website/alfareza.site%20-%20main/src/app/api/telegram/webhook/route.ts:22:0-24:1) or [(OFF)](cci:1://file:///Users/alfareza/Documents/Data/Code/Website/alfareza.site%20-%20main/src/app/api/telegram/webhook/route.ts:22:0-24:1)—allowing you to instantly freeze frontend functionality.
...
- 🗑️ **Delete / Curate Messages:** Inbox curation with dedicated `✅ Mark Read` / `🔴 Mark Unread` and `🗑 Delete` workflows.
...
graph TD
    ...
    G -->|Analyze Threat| H[Google Gemini AI]
    H -.->|Generates HTML Output| G
    G -.->|Dispatches Native Alert| D
...
<br />
<div align="center">
  <i>Deployed onto the edge with Vercel • Secured by Supabase & Antigravity.</i>
</div>
```

Feel free to copy this directly into your repository. It highlights the architecture perfectly!