      ...
      <div className="w-full max-w-sm space-y-6 p-8 border border-white/10 rounded-2xl bg-white/[0.02] shadow-2xl backdrop-blur-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center w-full h-10 rounded-md bg-purple-600 text-sm font-medium hover:bg-purple-700 disabled:opacity-50 transition-colors"
          >
